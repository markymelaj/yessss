...
export default async function AdminSolicitudesPage() {
  ...
  return (
    <section className="card p-5">
      <p className="text-sm font-bold uppercase tracking-[0.22em] text-amber-300">Casos abiertos</p>
      <div className="mt-4 grid gap-4">
        ...
        {solicitudes.length === 0 ? <p className="muted text-sm">No hay casos cargados.</p> : null}
      </div>
    </section>
  );
}
